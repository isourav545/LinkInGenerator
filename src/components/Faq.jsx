...
const Faq = () => {
  return (
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center">
            10 Amazing Features of LinkIn Generator
          </h2>
            ...
            <div>
              <div className="mb-10">
                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                  ...
                  Is it Updated with LinkedIN Latest UI??
                </h3>
              ...
              <div className="mb-10">
                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                  ...
                  Option for Verified Check Mark and Repost Count
                </h3>
                <p className="text-gray-500 dark:text-gray-400">
            ...
            <div>
              <div className="mb-10">
                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                  ...
                  Will have your friends believing your entirely fake
                  screenshots
                </h3>
                <p className="text-gray-500 dark:text-gray-400">
              ...
              <div className="mb-10">
                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                  ...
                  Can generate images of users blocking you or being suspended
                </h3>
                <p className="text-gray-500 dark:text-gray-400">
      ...
      <div className="bg-gray-900 h-screen/2">
      ...
      No more spending time in Photoshop
      </h1>
      <p className="mt-6 pb-12 text-center text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
       You can easily create High Impression LinkedIN Images with this Free LinkIN Generator
      </p>
